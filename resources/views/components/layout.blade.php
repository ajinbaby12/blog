...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/">
                    <img src="/images/blog.logo.png" alt="Laracasts Logo" width="165" height="16">
                </a>
            </div>
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                @auth
                    <x-dropdown>
                        ...
                        {{-- @can('admin') --}}     {{-- Functionally same as above if() --}}
                        @admin
                        {{-- Custom blade directive defined in AppServiceProvider that performs the above condition check --}}
                ...
                <a href="/feed"
                    class="ml-3 text-xs font-bold uppercase">
                    RSS
                </a>
